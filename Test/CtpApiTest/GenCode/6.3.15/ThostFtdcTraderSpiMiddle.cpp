...
void CThostFtdcTraderSpiMiddle::OnRspQueryMaxOrderVolume(, CThostFtdcQueryMaxOrderVolumeField *QueryMaxOrderVolumeCThostFtdcRspInfoField *RspInfo, int nRequestID, bool bIsLast)
{
