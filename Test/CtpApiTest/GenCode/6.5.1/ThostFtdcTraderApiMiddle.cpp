...
int CThostFtdcTraderApiMiddle::ReqQryMaxOrderVolume(, CThostFtdcQryMaxOrderVolumeField *QryMaxOrderVolumeint nRequestID)
{
	WRITE_LOG(LogLevel::Info, "ReqQryMaxOrderVolume: nRequestID[%d]", nRequestID);
	WriteQryMaxOrderVolume(QryMaxOrderVolume);

	return m_TraderApi->ReqQryMaxOrderVolume(, QryMaxOrderVolumenRequestID);
}
...
int CThostFtdcTraderApiMiddle::ReqQryClassifiedInstrument(, CThostFtdcQryClassifiedInstrumentField *QryClassifiedInstrumentint nRequestID)
{
	...
	return m_TraderApi->ReqQryClassifiedInstrument(, QryClassifiedInstrumentnRequestID);
}

int CThostFtdcTraderApiMiddle::ReqQryCombPromotionParam(, CThostFtdcQryCombPromotionParamField *QryCombPromotionParamint nRequestID)
{
	WRITE_LOG(LogLevel::Info, "ReqQryCombPromotionParam: nRequestID[%d]", nRequestID);
	WriteQryCombPromotionParam(QryCombPromotionParam);

	return m_TraderApi->ReqQryCombPromotionParam(, QryCombPromotionParamnRequestID);
}
