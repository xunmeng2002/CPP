...
public:
	...
	virtual void OnRspQueryMaxOrderVolume(, CThostFtdcQueryMaxOrderVolumeField *QueryMaxOrderVolumeCThostFtdcRspInfoField *RspInfo, int nRequestID, bool bIsLast);
